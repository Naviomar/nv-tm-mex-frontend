...
class FreightBanksModule extends FetchFactory<any> {
  private RESOURCE = '/freight-banks'

  async getFreightBanks(id: string, fetchOptions?: FetchOptions) {
    return this.call('GET', `${this.RESOURCE}/freight/${id}/all`, fetchOptions)
  }
...
export default FreightBanksModule
