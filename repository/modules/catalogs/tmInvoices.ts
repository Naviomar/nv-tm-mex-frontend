...
class TmInvoicesModule extends FetchFactory<IPortPagination> {
  private RESOURCE = '/tm-invoices'
  ...
  async createInvoiceTm(form: any, fetchOptions?: FetchOptions) {
    fetchOptions = {
      body: JSON.stringify(form),
      ...fetchOptions,
    }
    return this.call('POST', `${this.RESOURCE}/create-invoice`, fetchOptions)
  }
  ...
  async getCancelledForReInvoicing(params?: { referencia_id?: string; consignee_id?: string }, fetchOptions?: FetchOptions) {
...
export default TmInvoicesModule
