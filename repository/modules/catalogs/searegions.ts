...
class SeaRegionsModule extends FetchFactory<ISeaRegionPagination> {
  private RESOURCE = '/admin/sea-regions'

  async getSeaRegions(fetchOptions?: FetchOptions) {
...
export default SeaRegionsModule
