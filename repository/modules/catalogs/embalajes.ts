...
class EmbalajeModule extends FetchFactory<IServicesContractsPagination> {
  private RESOURCE = '/admin/embalajes'
   ...
   * @returns
   */
  async getEmbalajes(fetchOptions?: FetchOptions) {
