...
class CustomerBanksModule extends FetchFactory<any> {
  private RESOURCE = '/customer-banks'

  async getCustomerBanks(id: string, fetchOptions?: FetchOptions) {
    return this.call('GET', `${this.RESOURCE}/customer/${id}/all`, fetchOptions)
  }
...
export default CustomerBanksModule
