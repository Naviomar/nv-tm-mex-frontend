    ...
    <v-dialog v-model="showAgentChangeDialog" max-width="600" persistent>
      <v-card>
        ...
        <v-card-text class="pt-4">
          ...
          <!-- Users WITHOUT skip permission: this charge is generated by policy/law by default,
               so a separate, purpose-specific authorization is required to waive it — being
               authorized to redo/resend this revalidation is not enough on its own. -->
          <div v-if="agentChanged && !canSkipAgentChangeCharge" class="mt-2">
            <v-alert type="info" variant="tonal" density="compact" class="mb-2">
              <div class="text-sm">
                    ...
                    <div v-if="hasSentRevalidation">
                      <div class="flex flex-col">
                        ...
                        <ProcessAuthorizationWrapper
                          processName="sea-import-revalidation-resend"
