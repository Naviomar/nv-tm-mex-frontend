            ...
            >
              <td>
                <div class="flex gap-2">
                  ...
                  <EditButton :item="supplier" permission="supplier-types-edit" @click="edit(supplier)" />
                  <TrashButton :item="supplier" permission="supplier-types-delete" @click="showConfirmDelete" />
                </div>
              </td>
              <td>{{ supplier.name }}</td>
