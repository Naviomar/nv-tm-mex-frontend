      ...
      <v-card-text>
        <v-window v-model="currentTab">
          <v-window-item value="1">
            <AirExportEditForm :id="props.id" @reference-updated="handleReferenceUpdate" />
          </v-window-item>
          <v-window-item value="2">
            <AirExportPrintMasterAWB :id="props.id" />
          </v-window-item>
          <v-window-item value="3">
            <AirExportPrintHouseAwbTab v-if="currentTab === '3'" :id="props.id" />
          </v-window-item>
          <v-window-item value="4">
            ...
            <AirExportPrintReservation v-else :id="props.id" :reference="referenceData" />
          </v-window-item>
          <v-window-item value="5">
            ...
            <AirExportEmailReservation v-else :id="props.id" :reference="referenceData" />
          </v-window-item>
        </v-window>
      </v-card-text>
    </v-card>
