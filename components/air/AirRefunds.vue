<template>
  <div>
    <div class="flex justify-between items-center">
      ...
      <v-btn icon="mdi-refresh" color="red" variant="tonal" size="x-small" @click="getAirRefunds"></v-btn>
    </div>
...
const getAirRefunds = async () => {
  try {
    loadingStore.start()
    refunds.value = []
    const response = await $api.airServices.getRefunds(props.airReferenceId.toString())
