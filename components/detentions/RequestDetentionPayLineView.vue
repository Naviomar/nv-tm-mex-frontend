              ...
              <v-card-text>
                ...
                <div>
                  ...
                  <div class="grid grid-cols-3 gap-2">
                    ...
                    <div class="col-span-2">{{ reqDetention.referencia }}</div>
                  </div>
                </div>
              </v-card-text>
            </v-card>
...
const showSendNotyPay = async () => {
  ...
  const areaContacts = reqDetention.value.line?.contacts?.filter((c: any) => c.contact_type === 'import') || []
  const generalEmails = reqDetention.value.line?.emails || []
