...
const showConfirmDelete = async (item: any) => {
  ...
  if (result) {
    try {
      ...
      await $api.maritimeDemurrages.removeAttachment(props.reqDemurrage.id.toString(), body)
...
const onUploadClick = async () => {
  try {
    ...
    loadingStore.start()
    const response = (await $api.maritimeDemurrages.uploadAttachments(props.reqDemurrage.id, body)) as any
