        ...
        <div class="header-content">
          <div class="header-left">
            ...
            <div class="header-text">
              <h2 class="report-title">Comparative TEUs Report</h2>
              <p class="report-subtitle">Compare TEUs by Client and Destination across years or monthly breakdowns</p>
            </div>
          </div>
        </div>
      </div>
...
const applyFilters = async () => {
  try {
    ...
    const response = await $api.reports.exportComparativeTeusExcel(queryFilters)
