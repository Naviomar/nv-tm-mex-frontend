    ...
    <v-card elevation="0" class="report-card">
        ...
        <div class="header-content">
          <div class="header-left">
            ...
            <div class="header-text">
              <h2 class="report-title">Customer Invoices Report</h2>
              <p class="report-subtitle">Detailed invoice tracking for all customers</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <v-card-text class="pa-6">
        ...
        >
          ...
          This report includes invoice details from maritime and air services.
        </v-alert>
      </v-card-text>
    </v-card>
  </div>
...
const applyFilters = async () => {
  try {
    ...
    link.href = url
    link.setAttribute('download', `customer_invoices_report_${formatDate(new Date())}.xlsx`)
...
.report-header { background: linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%); position: relative; overflow: hidden; }
