    ...
    <v-card elevation="0" class="report-card">
        ...
        <div class="header-content">
          <div class="header-left">
            <div class="icon-wrapper">
              <v-icon color="white" size="28">mdi-account-file-outline</v-icon>
            </div>
            <div class="header-text">
              <h2 class="report-title">Executive Reports</h2>
              <p class="report-subtitle">Reporting data for executives</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <v-card-text class="pa-6">
        ...
        <v-alert type="info" variant="tonal" class="mt-6" density="compact">
          ...
          This report shows data for executives.
        </v-alert>
      </v-card-text>
    </v-card>
  </div>
...
const applyFilters = async () => {
  try {
    ...
    const response = await $api.reports.getExecutivesReport({
      query: queryFilters,
    })
