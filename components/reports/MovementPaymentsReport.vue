    ...
    <v-card elevation="0" class="report-card">
        ...
        <div class="header-content">
          <div class="header-left">
            ...
            <div class="header-text">
              <h2 class="report-title">Movement Payments Report</h2>
              <p class="report-subtitle">Payment movements and transactions tracking</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <v-card-text class="pa-6">
        ...
        >
          ...
          This report includes payment movements for all maritime and air references.
        </v-alert>
      </v-card-text>
    </v-card>
  </div>
...
const applyFilters = async () => {
  try {
    ...
    const response = await $api.reports.getMovementPayments({
      query: queryFilters,
    })
...
.report-header { background: linear-gradient(135deg, #10b981 0%, #059669 100%); position: relative; overflow: hidden; }
